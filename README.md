## Summary 📑
- [What is this?](https://github.com/lucioalmeidastockio/some-core-layer#what-is-this-)
- [First things first](https://github.com/lucioalmeidastockio/some-core-layer#first-things-first%EF%B8%8F)
- [Let there be PromotingEmployeeUseCase](https://github.com/lucioalmeidastockio/some-core-layer#let-there-be-promotingemployeeusecase-)
- [Input details](https://github.com/lucioalmeidastockio/some-core-layer#input-details-%EF%B8%8F)
- [Use Case Implementation](https://github.com/lucioalmeidastockio/some-core-layer#use-case-implementation-%EF%B8%8F)
   - [Abstraction, baby! Let's use Ports!](https://github.com/lucioalmeidastockio/some-core-layer#abstraction-baby-lets-use-ports-)
   - [Time for Business Entities!](https://github.com/lucioalmeidastockio/some-core-layer#time-for-business-entities-%EF%B8%8F)
   - [First half of our use case implementation](https://github.com/lucioalmeidastockio/some-core-layer#first-half-of-our-use-case-implementation-)
   - [Second half of our use case implementation](https://github.com/lucioalmeidastockio/some-core-layer#second-half-of-our-use-case-implementation-)
- [Use case factory](https://github.com/lucioalmeidastockio/some-core-layer#use-case-factory-)
   - [Factory package](https://github.com/lucioalmeidastockio/some-core-layer#factory-package-)
   - [Factory class](https://github.com/lucioalmeidastockio/some-core-layer#factory-class-%EF%B8%8F)
- [Dispatching the use case with its dependencies](https://github.com/lucioalmeidastockio/some-core-layer#dispatching-the-use-case-with-its-dependencies-)
   - [Core as a dependency](https://github.com/lucioalmeidastockio/some-core-layer#1-core-as-a-dependency-%EF%B8%8F)
   - [Create a new project for the adapters](https://github.com/lucioalmeidastockio/some-core-layer#2-create-a-new-project-for-the-adapters-)
   - [EmployeeRetrievementByIdPort & RoleRetrievementByIdPort adapters](https://github.com/lucioalmeidastockio/some-core-layer#3-employeeretrievementbyidport--roleretrievementbyidport-adapters-)
   - [CareerPathRetrievementPort adapter](https://github.com/lucioalmeidastockio/some-core-layer#4-careerpathretrievementport-adapter-)
   - [EmployeeAssignmentUpdatePort adapter](https://github.com/lucioalmeidastockio/some-core-layer#5-employeeassignmentupdateport-adapter-)
   - [Create a dispatcher for the specific use case implementation stack layer](https://github.com/lucioalmeidastockio/some-core-layer#6-create-a-dispatcher-for-the-specific-use-case-implementation-stack-layer-)
   - [Dispatcher as a dependency](https://github.com/lucioalmeidastockio/some-core-layer#7-dispatcher-as-a-dependency-%EF%B8%8F)
...
### 4. ``CareerPathRetrievementPort`` adapter 🔌
...
### 5. ``EmployeeAssignmentUpdatePort`` adapter 🔌
...
### 6. Create a dispatcher for the specific use case implementation stack layer 📦
...
Having followed those steps and really understood the thought process presented in this breakdown step-by-step example, it should become easy to build applications using Clean Architecture principles being levaraged by the [clean-arch-enablers](https://github.com/lucioalmeidastockio/clean-arch-enablers) library. 
